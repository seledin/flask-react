...
def keyword_historical(kw_list_in, region_state=GEO_IN):
...
def keyword_forecasted(kw_list_in, region_state=GEO_IN):
    big_keywords_dataframe=gt_data_extractor(kw_list_in, geo_in=region_state)
    timeframe_in='today 5-y'
    geo_in='US'
    span_manual=5
    ...
    return final_dataframe_forecasted



def keyword_rankers(kw_list_in, region_state=GEO_IN):
    big_keywords_dataframe=gt_data_extractor(kw_list_in, geo_in=region_state)
    timeframe_in='today 5-y'
    geo_in='US'
    span_manual=5
    ...
    return projected_growth_result, growth_rate_result
    # return projected_growth_result