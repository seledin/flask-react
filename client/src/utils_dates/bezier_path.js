...
const svgPath = (points, command, color) => {
  ...
  , '')
  return `<path d="${d}" fill="none" stroke="${color}" data-z-index="10 " stroke-width="2" pointer-events="none" />`
}
...
export function bezier_path(data, color){
    return svgPath(data, bezierCommand, color)
}